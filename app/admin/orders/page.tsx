              ...
              <Pagination>
                <PaginationContent>
                  <PaginationItem>
                    <PaginationPrevious
                      href="#"
                      className="rounded-md border border-border-subtle-subtle bg-transparent text-foreground hover:bg-gold-subtle/30 hover:text-foreground"
                    />
                  </PaginationItem>
                  <PaginationItem>
                    <PaginationLink
                      href="#"
                      isActive
                      className="border-primary bg-primary text-primary-foreground hover:bg-[#917300] hover:text-primary-foreground"
                    >
                      1
                    </PaginationLink>
                  </PaginationItem>
